...
# 資料夾路徑
json_folder = r"D:/dataset/marked_33/keypoints/"
image_folder = r"D:/dataset/marked_33/photos/"  # 確保這裡是存放對應圖片的資料夾
...
# 測試
file_path = "C:/Users/Win11/Desktop/Graduation_project/tests_33/path_to_output_folder_detected/3_keypoints.json"  # 你的新照片 JSON
database_path = "database33.json"  # 你的資料庫 JSON
...
class PoseCompare:
    ...
    connect_skeleton = [
        [0, 1], [1, 2], [2, 3], [3, 4],   # 頭部
        [1, 5], [5, 6], [6, 7], [1, 8], [8, 9], [9, 10],  # 身體
        [5, 11], [11, 12], [12, 13], [8, 14], [14, 15], [15, 16],  # 四肢
        [11, 17], [17, 18], [18, 19], [19, 20],  # 右手
        [12, 21], [21, 22], [22, 23], [23, 24],  # 左手
        [0, 25], [25, 26], [26, 27], [27, 28], [28, 29], [29, 30], [30, 31], [31, 32]  # 臉部
    ]

    
    kpts_angle = {
        "right_shoulder": [5, 1, 8],    # 右肩
        "right_elbow": [5, 6, 7],       # 右手肘
        "left_shoulder": [11, 1, 14],   # 左肩
        "left_elbow": [11, 12, 13],     # 左手肘
        "right_hip": [8, 9, 10],        # 右髖
        "right_knee": [9, 10, 19],      # 右膝
        "left_hip": [14, 15, 16],       # 左髖
        "left_knee": [15, 16, 20]       # 左膝
    }
...
result_img.show()
result_img.save('C:/Users/Win11/Desktop/Graduation_project/best_result/comparison_output33_3.png')  # 保存比較結果
